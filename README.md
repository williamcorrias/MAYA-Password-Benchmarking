...
### How To Add a Model
We're aware that integrating new models isn't as straightforward as it could be right now. We're actively working to simplify this process, and a more streamlined integration method will be available in an upcoming repository push.

In the meantime, if you desire to integrate a custom model into MAYA, follow these steps:
